...
int main() {
    ...
    float q = 1, a = 1, phi = 1, qmax = 1; // params of fs, fo
...
// ========================================================================== //
    ...
    cout << "Specify difference between initial times? (y / n) ";
    cin >> t0_choice_char;
...
//      Recast in units of dtsave (time between snapshots)
    if(t0_choice_char == 'n' || t0_choice_char == 'N') t0_dif = dtsave;
...
//      Calculate snapshot differences
    ...
    ratio = pow((1.0 * dt_snapshot_lg) / ratiosm, 1.0 / ntints);
