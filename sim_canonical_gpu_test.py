#Runs simulations and breaks trajectories into multiple files
import itertools
import math
import numpy as np
import copy
...
#calculate number of mc steps to run for each trajectory file...each file is generated by 5h of walltime
filetime = 10 #seconds to record 1 trajectory file
filesteps = rate*filetime
# Run sim
nfiles = 1
...
print("Production time: ",stoptime-equiltime)
