...
# Set up GCE
muvt = hoomd.hpmc.update.MuVT(['sphere1','sphere2'],ngibbs=1,max_volume_rescale=1,trigger=10)
...
stoptime = timeit.default_timer()
print()
print("particle1 number = ",muvt.N['sphere1'])
print("particle2 number = ",muvt.N['sphere2'])
print("total particle insertions = ",muvt.insert_moves)
print("total particle removals = ",muvt.remove_moves)
